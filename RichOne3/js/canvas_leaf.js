...
(function(b){
  ...
  function ash(o) {
    ...
    this.r = randomRange(236,172, m);
    this.g = randomRange(227, 107, m);
    this.b = randomRange(52, 36, m);
  ...
  function draw() {
    ...
    for(i = 0; i < A.length; i++) {
      ...
      grad.addColorStop(0, "rgba(26, 166, 173, 1)");
      grad.addColorStop(0.9, "rgba(26, 166, 173, "+randomRange(1,10)/10+")");
      grad.addColorStop(1, "rgba(26, 166, 173, 0)");
